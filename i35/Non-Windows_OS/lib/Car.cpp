...
void Node::drawNode(void){
    setColor(this->color);
    drawFilledBox(xPos, yPos, xPos + 9, yPos + 4);
    setColor(YELLOW);
    drawFilledBox(xPos+8, yPos+3, xPos+9, yPos+4);
    drawFilledBox(xPos+8, yPos, xPos+9, yPos+1 );
    setColor(RED);
    drawFilledBox(xPos, yPos, xPos+1, yPos+1);
    drawFilledBox(xPos, yPos+3, xPos+1, yPos+4);
}
